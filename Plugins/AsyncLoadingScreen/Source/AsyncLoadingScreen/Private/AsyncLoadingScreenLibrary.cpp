...
void UAsyncLoadingScreenLibrary::StopLoadingScreen()
{
	...
	UE_LOG(LogTemp, Warning, TEXT("stop loading screen"));
}
...
void UAsyncLoadingScreenLibrary::ShowLoadingScreen()
{
	//GetMoviePlayer()->StopMovie();
	bool bOldEnable = bShowLoadingScreen;
	bShowLoadingScreen = true;
	GetMoviePlayer()->PlayMovie();
	bShowLoadingScreen = bOldEnable;
}